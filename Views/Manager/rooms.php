        ...
        <div class="col-md-10">
            ...
            <div class="p-4">
                <div class="d-flex justify-content-between mb-3">
                    <h4>All Rooms</h4>
                    <a href="room_form.php" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Add Room</a>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($r['status'] === 'dirty'): ?>
                                            <span class="badge bg-secondary">Dirty</span>
                                        <?php elseif (in_array($r['status'], ['clean','inspected'])): ?>
                                            <span class="badge bg-success">Clean</span>
                                        <?php elseif ($r['status'] === 'out_of_order'): ?>
                                            <span class="badge bg-danger">Out of Order</span>
                                        <?php elseif ($r['status'] === 'maintenance'): ?>
                                            <span class="badge bg-dark">Maintenance</span>
                                        <?php else: ?>
                                            <span class="badge bg-info"><?= htmlspecialchars($r['status']) ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <a href="room_form.php?id=<?= (int)$r['id'] ?>" class="btn btn-sm btn-outline-primary">Edit</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
